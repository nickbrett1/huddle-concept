			...
			items: [
				{
                    ...
                    details: [
                        { label: 'Hyper-Personalization', text: 'While we showcase three core personas, the system uses real-time clustering to generate thousands of narrative variants based on the "Knowledge Space" of the audience.' },
