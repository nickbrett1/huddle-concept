				...
				<div class="persona-selector">
					...
					<div class="buttons" class:unselected={!selectedPersona}>
						{#each personas as persona, i}
							...
							>
								<span class="icon">{@html persona.icon}</span>
								<div class="info">
